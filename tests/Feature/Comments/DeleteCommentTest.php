...
class DeleteCommentTest extends TestCase
{
    ...
    /** @test */
    public function deleting_a_comment_does_not_work_when_user_does_not_have_authorization_because_different_user_created_idea()
    {
    ...
    /** @test */
    public function deleting_a_comment_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
        $comment = Comment::factory()->create([
    ...
    /** @test */
    public function deleting_a_comment_does_not_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
        $comment = Comment::factory()->create([
