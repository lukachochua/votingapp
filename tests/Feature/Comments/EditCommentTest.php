...
class EditCommentTest extends TestCase
{
    ...
    /** @test */
    public function edit_a_comment_form_validation_works()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function editing_a_comment_does_not_work_when_user_does_not_have_authorization_because_different_user_created_idea()
    {
    ...
    /** @test */
    public function editing_a_comment_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
        $comment = Comment::factory()->create([
    ...
    /** @test */
    public function editing_a_comment_does_not_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
        $comment = Comment::factory()->create([
