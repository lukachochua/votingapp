...
class GravatarTest extends TestCase
{
    ...
    /** @test */
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_charecter_a() 
    {
    ...
    /** @test */
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_charecter_z() 
    {
        $user = User::factory()->create([
            'name' => 'Luka',
    ...
    /** @test */
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_charecter_0() 
    {
        $user = User::factory()->create([
            'name' => 'Luka',
    ...
    /** @test */
    public function user_can_generate_gravatar_default_image_when_no_email_found_first_charecter_9() 
    {
        $user = User::factory()->create([
            'name' => 'Luka',
