...
class DeleteIdeaTest extends TestCase
{
    ...
    /** @test */
    public function does_not_show_delete_idea_livewire_ccomponen_when_user_does_not_have_autorization()
    {
        $user = User::factory()->create();
    ...
    public function deleting_an_idea_works_when_user_has_authorization_and_idea_has_comments()
    {
      ...
      /** @test */
    public function deleting_an_idea_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function deleting_an_idea_does_not_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
