...
class OtherFiltersTest extends TestCase
{
    ...
    /** @test */
    public function my_ideas_filter_works_correctly_when_when_user_logged_in()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
    ...
    /** @test */
    public function my_ideas_filter_works_correctly_when_when_user_is_not_logged_in()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
