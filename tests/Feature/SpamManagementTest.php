...
class SpamManagementTest extends TestCase
{
    ...
    /** @test */
    public function marking_an_idea_as_spam_shows_on_menu_when_user_has_autorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function marking_an_idea_as_spam_does_not_show_on_menu_when_user_has_autorization()
    {
