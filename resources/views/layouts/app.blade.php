...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto flex flex-col md:flex-row max-w-custom" style="max-width:1000px">
            <div class="w-70 mx-auto md:mr-5 md:mx-0">
                ...
                >
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full border-none bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2"
