    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            ...
            <div class="flex items-center">
                ...
                @endif
                <a href="#">
                    <img src="https://www.gravatar.com/avatar/000000000000000000000000000000?d=mp" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
        ...
        <main class="container mx-auto flex max-w-custom" style="max-width:1000px">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque fugiat quo exercitationem minima! Officia doloribus pariatur vel obcaecati unde corporis quaerat quasi, et cumque minima fugiat, consequatur distinctio odit assumenda.
            </div>
